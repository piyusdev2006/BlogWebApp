...
const PLATFORM_META = {
  ...
  github:    { label: "GitHub",        placeholder: "https://github.com/yourhandle" },
  linkedin:  { label: "LinkedIn",      placeholder: "https://linkedin.com/in/yourhandle" },
 ...
 *
 * Props:
 *   value    – object { twitter: "", github: "", ... }
 *   onChange – called with the updated object when any field changes
 */
      ...
      {Object.keys(PLATFORM_META).map((platform) => {
        ...
        return (
          <div key={platform} className="flex items-center gap-3">
            {/* Icon */}
            <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-lg bg-surface-1 border border-hairline text-ink-tertiary">
            ...
            <div className="flex-1">
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-surface-1 border border-hairline text-body-sm text-ink placeholder:text-ink-tertiary focus:outline-none focus:border-primary/60 focus:ring-1 focus:ring-primary/30 transition-all"
              />
            </div>
            ...
            {value[platform] && (
              <button
                ...
                className="flex-shrink-0 p-1.5 rounded-md text-ink-tertiary hover:text-ink hover:bg-surface-1 transition-colors"
...
export { PLATFORM_META, PLATFORM_ICONS };
